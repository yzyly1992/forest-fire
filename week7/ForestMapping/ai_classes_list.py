classes = {
    ...
    # ],
    'risks': [
        {'name': '0', 'title': 'green', 'hex_color': '#00FF00', 'rgb_color': (70, 230, 70)},
        {'name': '1', 'title': 'yellow', 'hex_color': '#FFFF00', 'rgb_color': (255, 250, 0)},
        {'name': '2', 'title': 'orange', 'hex_color': '#FF4500', 'rgb_color': (255, 69, 0)},
        {'name': '3', 'title': 'red', 'hex_color': '#FF0000', 'rgb_color': (255, 5, 5)},
        {'name': '4', 'title': 'blue', 'hex_color': '#0000FF', 'rgb_color': (30, 30, 255)}
    ]
}
