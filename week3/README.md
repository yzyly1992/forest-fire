...
#### YOLOV5
Repo: [https://github.com/ultralytics/yolov5](https://github.com/ultralytics/yolov5)  
...
#### YOLOV6
Repo: [https://github.com/meituan/YOLOv6](https://github.com/meituan/YOLOv6) 
...
#### YOLOV7
Repo: [https://github.com/WongKinYiu/yolov7](https://github.com/WongKinYiu/yolov7)  
...
- mAP values are for single-model single-scale on [COCO val2017](http://cocodataset.org) dataset.
...
- Speed averaged over COCO val images using an [Amazon EC2 P4d](https://aws.amazon.com/ec2/instance-types/p4/)
  ...
  ## Conclusion
  For large input size and best accuracy without considering the performance/speed, the best model for each version are:
  - YOLOv5x6
  - YOLOv6l6
  - YOLOv7-E6E
  - YOLOv8x
